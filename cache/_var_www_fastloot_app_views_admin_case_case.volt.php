        ...
        <div class="control-group">
            ...
            <div class="controls">
                <select class="span6 m-wrap" name="status">
                    <option value="1" <?php if ($case->status == 1) { ?> selected <?php } ?>>Выкл</option>
                    <option value="0" <?php if ($case->status == 0) { ?> selected <?php } ?>>Вкл</option>
                </select>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <select class="span6 m-wrap" name="type">
                    <option value="1" <?php if ($case->type == 1) { ?> selected <?php } ?>>Денежные призы</option>
                    <option value="2" <?php if ($case->type == 2) { ?> selected <?php } ?>>Крутые призы</option>
                    <option value="3" <?php if ($case->type == 3) { ?> selected <?php } ?>>Цифровые  призы</option>
                </select>
            </div>
        </div>
