    ...
    <div class="case-page"><a href="/" onclick="Page.Go(this.href); return false;"
        ...
        <div class="spin">
            ...
            <?php if ($case->price != 0) { ?>
                <div class="chance">
                <div class="cls"></div>
                <p><input type="checkbox" name="chance" value="<?= $this->tag->round($case->price / 10) ?>" class="lcs_check"
                          data-lcs="1"/> <b>+10%</b> к шансу</p>
                <p><input type="checkbox" name="chance" value="<?= $this->tag->round($case->price / 5) ?>" class="lcs_check"
                          data-lcs="2"/> <b>+20%</b> к шансу</p>
                <p><input type="checkbox" name="chance" value="<?= $this->tag->round($case->price / 3.33333333333) ?>"
            ...
            <div class="button">
                ...
                <button class="btn blue rounded" onclick="spinbox(<?= $case->id ?>, this, window.spin_count);"> <?php if ($case->price != 0) { ?>Открыть кейс
                    за <span><b
                                id="spin-amount"><?= $case->price ?></b><span class="flaticon-ruble"></span></span><?php } else { ?> Открыть бесплатно <?php } ?>
                </button>
            </div>
            <div class="cls"></div>
        </div>
