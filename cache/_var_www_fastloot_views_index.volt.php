...
<head>
    ...
    <?= $this->tag->stylesheetLink('css/style.min.css') ?>
...
<div class="wrapper">
    <header class="header">
        <div class="inner">
            <div class="logo"><a href="/" onclick="Page.Go(this.href); return false;"><img src="/images/logo@2x.png" alt="4Cash"></a>
            </div>
            <div class="stat">
                <div class="o">Онлайн
            ...
            <div class="u-menu">
                <?php if ($this->session->auth) { ?>
                    ...
                    <div class="u-menu">
                        <div class="userpic"><a href="/user/<?= $this->session->auth['userid'] ?>"><img
                                        src="<?= $this->session->auth['avatar'] ?>" alt="Киясов Ислам"></a>
                        </div>
                        <div class="balance-mobile"><span id="user-balance-mobile">0</span><span
                                    class="flaticon-ruble ruble"></span></div>
                        <div class="userinfo">
                            <div class="name"><a href="/user/<?= $this->session->auth['userid'] ?>" class="eas">Мой аккаунт</a>
                            </div>
                            <div class="price"><span class="flaticon-money"></span> <b id="user-balance">0</b><span
        ...
        <div class="inner">
            <div class="l">
                <ul>
                    ...
                    <li><a href="/reviews" onclick="Page.Go(this.href); return false;" class="eas ">Отзывы</a></li>
                    <li><a href="/support" onclick="Page.Go(this.href); return false;" class="eas ">Техническая поддержка</a></li>
                </ul>
                <div class="copy">
...
<div id="deposit" class="popup" style="display: none;">
    <div class="popup-container" style="top: 50%;">
        ...
        <span class="payment-method eas pm-yandex" onclick="changePaymentMethod('yandex');"><img
                    ...
                    src="/images/payment-qiwi.svg" alt="Interkassa (QIWI)"><span class="flaticon-check"></span></span><span
