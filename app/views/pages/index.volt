    ...
    <div class="cases">
        ...
        <div class="cases"><h1>Денежные призы</h1>
            ...
            <div class="cases-default">
                {% for i in case %}
                    {% if i.type == 1 %}
                        <div class="case-default   {% if i.price > 100 %} sum-4 {% endif %}">
                            <div class="inside eas">
                                <h3><a href="/case/{{ i.id }}">{{ i.name }}</a></h3>
                                <div class="paid">выиграли: {% if i.mwin is empty %}0{% else %}{{ i.mwin }}{% endif %}
                                    р
                                </div>
                                <div class="price">
                                    {% if i.price == 0 %} Бесплатно {% else %} {{ i.price }}<span
                                            class="flaticon-ruble"> {% endif %}</span>
                                    <div>стоимость</div>
                                </div>
                                <div class="cls"></div>
